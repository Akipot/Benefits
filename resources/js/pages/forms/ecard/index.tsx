...
const formSchema = z
    .object({
        ...
        bdoCity: z.string().min(1, "City is required."),
        bdoProvince: z.string().min(1, "Provice/State is required."),
...
export default function Show() {
    ...
    //     const bdoSig1Empty = bdoSigRef1.current?.isEmpty?.();
    //     const bdoSig2Empty = bdoSigRef2.current?.isEmpty?.();

    //     const otherErrors = Object.keys(form.formState.errors).filter(
    //         (key) =>
    //             !["signature1", "bdoSignature1", "bdoSignature2"].includes(key)
    //     );

    //     if (!isValid) {
    //         if ((signatureEmpty || bdoSig1Empty || bdoSig2Empty) && otherErrors.length === 0) {
    //             toast.error("Please provide all required signatures before submitting.");

    //             if (signatureEmpty) {
    //                 form.setError("signature1", {
    //                     type: "manual",
    //                     message: "Signature is required",
    //                 });
    //             }
    //             if (bdoSig1Empty) {
    //                 form.setError("bdoSignature1", {
    //                     type: "manual",
    //                     message: "Signature is required",
    //                 });
    //             }
    //             if (bdoSig2Empty) {
    //                 form.setError("bdoSignature2", {
    //                     type: "manual",
    //                     message: "Signature is required",
    //                 });
    //             }
    ...
    //     // check signatures even if form is valid
    //     if (signatureEmpty || bdoSig1Empty || bdoSig2Empty) {
    //         toast.error("Please provide all required signatures before submitting.");
                                                ...
                                                {/* <div className="flex flex-col md:w-[600px] w-full">
                                                        ...
                                                        render={({ field, fieldState }) => (
                                                            <>
                                                                <SignaturePad
                                                                    ...
                                                                    className="border border-gray-300 rounded"
                                                                    onEnd={async () => {
                                                                        if (bdoSigRef1.current && !bdoSigRef1.current.isEmpty()) {
                                                                            const dataForPDF = await bdoSigRef1.current.getDataForPDF();
                                                                            setValue("bdoSignature1", dataForPDF, { shouldValidate: true });
                                                                        }
                                                                    }}
                                                                />
                                                                {fieldState.error && (
                                                    ...
                                                    <div className="mt-2 flex justify-end">
                                                        <Button
                                                            ...
                                                            variant="outline"
                                                            onClick={() => {
                                                                bdoSigRef1.current?.clear();
                                                                form.setValue("bdoSignature1", "");
                                                            }}
                                                            className="bg-red-500 text-white hover:bg-red-600 border-none dark:bg-red-400 dark:text-black dark:hover:bg-red-500 cursor-pointer"
                                                        >
                                                            Clear
                                                ...
                                                {/* <div className="flex flex-col md:w-[600px] w-full">
                                                        ...
                                                        render={({ field, fieldState }) => (
                                                            <>
                                                                <SignaturePad
                                                                    ...
                                                                    className="border border-gray-300 rounded"
                                                                    onEnd={async () => {
                                                                        if (bdoSigRef2.current && !bdoSigRef2.current.isEmpty()) {
                                                                            const dataForPDF = await bdoSigRef2.current.getDataForPDF();
                                                                            setValue("bdoSignature2", dataForPDF, { shouldValidate: true });
                                                                        }
                                                                    }}
                                                                />
                                                                {fieldState.error && (
                                                    ...
                                                    <div className="mt-2 flex justify-end">
                                                        <Button
                                                            ...
                                                            variant="outline"
                                                            onClick={() => {
                                                                bdoSigRef2.current?.clear();
                                                                form.setValue("bdoSignature2", "");
                                                            }}
                                                            className="bg-red-500 text-white hover:bg-red-600 border-none dark:bg-red-400 dark:text-black dark:hover:bg-red-500 cursor-pointer"
                                                        >
                                                            Clear
